...
print(standard_fraction_design)

```

```{r, echo = FALSE, warning = FALSE}

knitr::kable(print(standard_fraction_design), "pipe")
...
```{r, results = "hide"}
# Observe contents of cB
print(tilac_fraction_design)

```

```{r, echo = FALSE, warning = FALSE}

knitr::kable(print(tilac_fraction_design), "pipe")
...
knitr::kable(print(fd_table), "pipe")
...
knitr::kable(print(replaced_df), "pipe")
...
In the last section, we discussed how `EstimateFractions()` basic functionality
...
be saved in the `ezbdo$mutation_rates` list. 
