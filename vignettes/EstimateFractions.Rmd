...
**NOTE**: This is experimental functionality. A preprint will be out soon describing
how to optimize these kinds of analyses.
...
write_dataset(
  simdata$cB,
  path = paste0(outdir, "\\arrow_dataset"),
  format = "parquet",
  partitioning = "sample"
)

ds <- open_dataset(paste0(outdir, "\\arrow_dataset"))
