...
A `ggplot2` object. Y-axis = log2(estimate of interest (e.g.,
fold-change in degradation rate constant); X-axis = log10(average
normalized read coverage); points colored by location relative to FDR
and effect size cutoffs.

## Details

`EZMAPlot()` accepts as input the output of
...
interpret and more common for these kind of visualizations, `EZMAPlot()`
